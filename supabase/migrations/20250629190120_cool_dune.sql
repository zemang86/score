/*
  ...
  1. Policy Updates
    - Add admin bypass to all existing policies
    - Create separate policies for each CRUD operation
    - Ensure admins can access all data while maintaining parent restrictions

  2. Security
    - Maintain existing parent access controls
    - Add admin override capabilities
    - Proper policy separation for clarity
