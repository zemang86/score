          ...
          <div className="flex flex-col justify-center max-w-lg relative z-10">
            <div className="mb-8">
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-6 border border-white/10">
                <p className="text-3xl font-bold mb-3 text-indigo-200">{t('auth.welcomeTitle')}</p>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 bg-white/5 backdrop-blur-lg rounded-2xl p-4 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <div>
                  <h3 className="font-bold text-xl text-indigo-200">{t('auth.gamifiedLearning')}</h3>
                  <p className="text-indigo-100">{t('auth.gamifiedDescription')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 bg-white/5 backdrop-blur-lg rounded-2xl p-4 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <div>
                  <h3 className="font-bold text-xl text-indigo-200">{t('auth.trackProgress')}</h3>
                  <p className="text-indigo-100">{t('auth.trackProgressDescription')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 bg-white/5 backdrop-blur-lg rounded-2xl p-4 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <div>
                  <h3 className="font-bold text-xl text-indigo-200">{t('auth.familyDashboard')}</h3>
                  <p className="text-indigo-100">{t('auth.familyDashboardDescription')}</p>
                </div>
              </div>
            </div>
